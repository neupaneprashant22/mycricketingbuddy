...
var onstrike = 1;
var batsman_table = document.querySelector(".Second-innings-table-batsman");
...
bowler_runs = [];
current_bowler = 1;
var bowler_table = document.querySelector(".Second-innings-table-bowler");
...
document.getElementById("match-of").innerHTML = team1 + " vs " + team2;
document.getElementById("toss").innerHTML +=
  toss + " won the toss and decided to " + decide + " first.";
document.getElementById("target-h3").innerHTML = "Target:" + target;
...
startsecond.addEventListener("click", function (e) {
  ...
  myobj.winner = winner;
  myobj.balls_remaning = parseInt(myobj.overs * 6) - totalBalls;
  myobj.runs_remaning = target - totalruns - 1;
  myobj.wickets_remaning = maxwickets - totalwickets;
...
noball.addEventListener("click", function (e) {
  ...
  if (isstart != true) {
    ...
    } while (!(noball_runs >= 0 && noball_runs <= 6));
    showUpdated();
    checkStatus();
  } else {
    alert("Match has ended");
...
function showUpdated() {
  ...
  document.getElementById("to-win").innerHTML =
    "Runs remaning:" + (target - totalruns);
  document.getElementById("balls-remaning").innerHTML =
    "Balls remaning:" + (parseInt(myobj.overs * 6) - totalBalls);
  document.getElementById("required-rr").innerHTML =
    "Required Runrate:" +
    ((target - totalruns) / (parseInt(myobj.overs * 6) - totalBalls)) * 6;
  ...
  if (overs - parseInt(overs) == 0 && isstart != true) {
    chooseBowler();
  }
}
